...
This is a simple Todo list app built with HTML, CSS and Javascript. The app has all basic functions that allows users add, delete and filter todos. Users can also drag and drop to rearrange the todos 😉
